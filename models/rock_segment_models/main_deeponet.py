...
from rock_seg_model.deeponet_rock_seg.model_deeponet import DeepONetConv
...
def save_predictions(images, masks_true, masks_pred, filenames, epoch, save_dir="results_v1/deeponet"):
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results_v1/deeponet/loss_curve.png")
plt.close()
