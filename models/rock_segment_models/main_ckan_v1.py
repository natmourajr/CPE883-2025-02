...
from rock_seg_model.ckan_rock_seg.model_ckan_v1 import CKANSegmentationModel
from rock_seg_model.ckan_rock_seg.ckan_config import CKAN_CONFIG
...
def save_predictions(images, masks_true, masks_pred, filenames, epoch, save_dir="results_v1/CKAN"):
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results_v1/CKAN/loss_curve.png")
plt.close()
