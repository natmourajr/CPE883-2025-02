...
# DataLoading
nlp_dataloader = NLPDataLoader(tokenizer, block_size, model, dataset_name, split_ratio, retokenize)
...
# TODO, probably remove this and refactor the code to work better with my dataloader
data_dir = nlp_dataloader.data_dir
...
def get_batch(split):
    ...
    # TODO put into dataloader
    x, y = x.to(device), y.to(device)

    return x, y


def log_all(iter_num, train_loss, val_loss, lr):
...
while True:
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        dtlog = tlog1 - tlog0
        tlog0 = tlog1
        log_all(iter_num, losses['train'], losses['val'], dtlog*1000)
