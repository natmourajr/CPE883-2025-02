...
Surrupiado de:
Stolen from:
  https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/diffusion/stable_diffusion/util.py
...
from models.stable-diffusion.model.autoencoder import Encoder, Decoder, Autoencoder
