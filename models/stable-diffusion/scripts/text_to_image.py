...
Surrupiado de:
Stolen from:
  https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/diffusion/stable_diffusion/scripts/text_to_image.py
...
from models.stable-diffusion.sampler.ddpm import DDPMSampler
from models.stable-diffusion.util import load_model, save_images, set_seed
