...
def LSTM(serie_size=-1, window_size=6, predict_steps=1, batch_size=32, epochs=20,
        input_size=1, hidden_size=64, num_layers=2, output_size=1, test_ratio=0.2,
        folds=4):
    
    """
    Window size is the same that look_back
    """
    ...
    final_model = LSTMPredictor(input_size, hidden_size, num_layers, output_size)
