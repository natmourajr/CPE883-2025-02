# Experimento: CapsNet-Stride-xray_Xray

Este diretório contém o script principal para executar o pipeline completo de treinamento e avaliação para a arquitetura **CapsNet** no dataset de Tuberculose.
...
```Bash
python experiments/CapsNet-stride-xray/run_experiment.py
```
...
`results/CapsNet_Strided/[YYYYMMDD_HHMMSS]/`
