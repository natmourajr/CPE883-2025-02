...
nlp_dataloader = NLPDataLoader(tokenizer, block_size, out_dir, dataloader, dataset_name, split_ratio, False)
...
load_meta = False
if init_from == 'resume' and 'config' in checkpoint and 'dataset': # older checkpoints might not have these...
